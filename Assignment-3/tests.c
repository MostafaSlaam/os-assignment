...
int TestAss3Q1()
{
	...
	if (pa != 0x1000)
	{
		cprintf("[EVAL] #1 FindPhysicalAddress Failed. Evaluation = 0\n");
		return 0;
	}
	...
	if (pa != 0x100000)
	{
		cprintf("[EVAL] #2 FindPhysicalAddress Failed. Evaluation = 0\n");
		return 0;
	}
	...
	if (pa != -1)
	{
		cprintf("[EVAL] #3 FindPhysicalAddress Failed. Evaluation = 0\n");
		return 0;
	}
	...
	if (pa != 5)
	{
		cprintf("[EVAL] #4 FindPhysicalAddress Failed. Evaluation = 0.5\n");
		return 0;
	}
	...
	if (pa != 0x100555)
	{
		cprintf("[EVAL] #5 FindPhysicalAddress Failed. Evaluation = 0.5\n");
		return 0;
	}
	...
	if (pa != 0x100100)
	{
		cprintf("[EVAL] #6 FindPhysicalAddress Failed. Evaluation = 0.5\n");
		return 0;
	}
	...
	if (pa != -1)
	{
		cprintf("[EVAL] #7 FindPhysicalAddress Failed. Evaluation = 1\n");
		return 0;
	}

	cprintf("[EVAL] Q1 Automatic Test: Succeeded. Evaluation = 1.5\n");
...
int TestAss3Q2()
{
	...
	{
		cprintf("[EVAL] Test Failed #3. Evaluation = 0.5\n");
		return 0;
	}
	...
	{
		cprintf("[EVAL] #4 ShareRangeWithPermissions: Failed. Evaluation = 0.5\n");
		return 0;
	}

	cprintf("[EVAL] Q2 Automatic Test: Succeeded. Evaluation = 1\n");
	return 0;
}
...
int TestAss3Q3()
{
	...
	if (va  != 0xF0001000)
	{
		cprintf("[EVAL] #1 FindVirtualOfFrameNum: Failed. Evaluation = 0\n");
		return 0;
	}
	...
	if (va  != 0x00004000)
	{
		cprintf("[EVAL] #2 FindVirtualOfFrameNum: Failed. Evaluation = 0.5\n");
		return 0;
	}
	...
	if (va  != 0xF0064000)
	{
		cprintf("[EVAL] #3 FindVirtualOfFrameNum: Failed. Evaluation = 1\n");
		return 0;
	}
	...
	if (va  != -1)
	{
		cprintf("[EVAL] #4 FindVirtualOfFrameNum: Failed. Evaluation = 1\n");
		return 0;
	}
...
int TestAss3QB()
{
	//[1] Connect with write and user permissions [0.5 MARK]
	...
	if ((ref2 - ref1) != 0)
	{
		cprintf("[EVAL] #1 ConnectPageToFrame: Failed. You should manually implement the connection logic using paging data structures ONLY. [DON'T update the references]. Evaluation = 0\n");
		return 0;
	}
	...
	{
		cprintf("[EVAL] #2 ConnectPageToFrame: Failed. Evaluation = 0\n");
		return 0;
	}


	//[2] Connect with write and kernel permissions [0.5 MARK]
	...
	{
		cprintf("[EVAL] Test Failed #2. Evaluation = 0.5\n");
		return 0;
	}
	...
	if ((ref2 - ref1) != 0)
	{
		cprintf("[EVAL] #3 ConnectPageToFrame: Failed. You should manually implement the connection logic using paging data structures ONLY. [DON'T update the references]. Evaluation = 0.5\n");
		return 0;
	}
	...
	{
		cprintf("[EVAL] #4 ConnectPageToFrame: Failed. Evaluation = 0.5\n");
		return 0;
	}
	...
	*ptr2 = 'B';
	...
	//[3] Connect with read and user permissions [0.5 MARK]
	...
	{
		cprintf("[EVAL] Test Failed #3. Evaluation = 1\n");
		return 0;
	}
	...
	if ((ref2 - ref1) != 0)
	{
		cprintf("[EVAL] #5 ConnectPageToFrame: Failed. You should manually implement the connection logic using paging data structures ONLY. [DON'T update the references]. Evaluation = 1\n");
		return 0;
	}
	...
	{
		cprintf("[EVAL] #6 ConnectPageToFrame: Failed. Evaluation = 1\n");
		return 0;
	}

	cprintf("[EVAL] BONUS Automatic Test: Succeeded. Evaluation = 1.5\n");
